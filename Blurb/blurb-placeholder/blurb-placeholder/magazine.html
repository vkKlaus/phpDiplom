    		...
    		<div class="row d-flex align-items-center">
                ...
                ============================== -->
                    <div class="header-banner d-flex align-items-center ">
                       <a href="shop-left-sidebar.html" class="btn btn-primary wd-shop-btn ml-auto">Buy now</a>
                    </div>
								...
								<div class="dropdown wd-compare-btn">
								  ...
								  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
								  	...
								  	<div class="media text-center">
										<a href="compare-products.html" class="btn btn-primary go-compare-page">Compare <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
									</div>
								  </div>
								</div>
							</div>
